...
class Admin::VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_video" do
    assert_difference("Admin::Video.count") do
      post admin_videos_url, params: { admin_video: { admin_courses_id: @admin_video.admin_courses_id, descricao: @admin_video.descricao, link: @admin_video.link, nome: @admin_video.nome } }
    end
  ...
  test "should update admin_video" do
    patch admin_video_url(@admin_video), params: { admin_video: { admin_courses_id: @admin_video.admin_courses_id, descricao: @admin_video.descricao, link: @admin_video.link, nome: @admin_video.nome } }

...
class Admin::AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_administrator" do
    assert_difference("Admin::Administrator.count") do
      post admin_administrators_url, params: { admin_administrator: { cpf: @admin_administrator.cpf, email: @admin_administrator.email, nome: @admin_administrator.nome, senha: @admin_administrator.senha, telefone: @admin_administrator.telefone } }
    end
  ...
  test "should update admin_administrator" do
    patch admin_administrator_url(@admin_administrator), params: { admin_administrator: { cpf: @admin_administrator.cpf, email: @admin_administrator.email, nome: @admin_administrator.nome, senha: @admin_administrator.senha, telefone: @admin_administrator.telefone } }
